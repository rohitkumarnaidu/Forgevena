...
> **Purpose:** Feature specification for Governed Engineering Copilots.
...
- **Feature ID:** `governed-engineering-copilots`
- **Classification:** committed
- **Owner:** Engineering Intelligence Maintainers

## Purpose and Problem

Provide architecture, dependency, security, test-gap, documentation, upgrade, and release recommendations.

## Business and Developer Value

Teams receive explainable planning assistance grounded in local evidence.

## Architecture

Copilots query governed indexes and providers, emit read-only plans, and route approved mutations through existing managed operations.
...
- Mutation requires preview and explicit consent.
...
- Model drift changes output quality.
