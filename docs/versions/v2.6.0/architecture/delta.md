...
Add recommendation evidence and host bridges over shared domain APIs without duplicating package, policy, or execution logic.

```mermaid
flowchart LR
  U["User or governed automation"] --> P["Preview and policy"]
  P --> C["ForgeHub Intelligence and Experience"]
