...
Extend local and optional control-plane governance with organization package inventories, approval workflows, delegated administration, policy simulation, and distribution promotion.

```mermaid
flowchart LR
  U["User or governed automation"] --> P["Preview and policy"]
  P --> C["Organization Ecosystem Management"]
