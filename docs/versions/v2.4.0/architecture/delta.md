...
Add schema-driven Capability Studio profiles, publisher APIs, adapter/converter SDKs, staged publication, identity, ownership, recovery, and moderation workflows.

```mermaid
flowchart LR
  U["User or governed automation"] --> P["Preview and policy"]
  P --> C["Publisher Platform and Ecosystem SDK"]
