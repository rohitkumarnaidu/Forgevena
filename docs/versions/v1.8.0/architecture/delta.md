...
Add metadata-only logs, metrics, traces, diagnostics, immutable audit exports, supply-chain evidence, and generated canonical references.

```mermaid
flowchart LR
  U["User or governed automation"] --> P["Preview and policy"]
  P --> C["Observability, Supply Chain, and Documentation"]
