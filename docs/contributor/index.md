...
Issues should include version, platform, redacted output, reproduction, expected behavior, and risk. Never attach credentials, prompts, responses, or private repository content. See [CONTRIBUTING](https://github.com/rohitkumarnaidu/Forgevena/blob/main/CONTRIBUTING.md), [Code review](../CODE_REVIEW_GUIDELINES.md), and [Issue triage](../ISSUE_TRIAGE.md).
