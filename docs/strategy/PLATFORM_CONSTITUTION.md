...
Release identity remains evidence-based. Prerelease source metadata may be published in generated technical references for reproducibility, but it cannot displace current stable installation guidance or imply stable compatibility, security, or support certification before immutable release gates pass.
