...
2. Complete `v1.4` provider contracts, privacy classifications, bounded retries and fallback, compatibility evidence, and credential-gated smoke tests before expanding higher-level ecosystem claims. The local implementation remains preview maturity until hosted and live release evidence passes.
