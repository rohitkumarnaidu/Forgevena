...
2. Complete `v1.4` provider contracts, privacy classifications, bounded retries and fallback, compatibility evidence, and credential-gated smoke tests before expanding higher-level ecosystem claims. The implementation passed its merge checkpoint and is preparing `v1.4.0-rc.1`; it remains preview maturity until release-candidate and live compatibility evidence pass.
