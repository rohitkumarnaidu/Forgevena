...
function nuspec(packageVersion) {
  return `<?xml version="1.0"?><package><metadata><id>forgevena</id><version>${packageVersion}</version><authors>Rohit Kumar Naidu</authors><description>Governed engineering from idea to production.</description><projectUrl>${repositoryUrl}</projectUrl><license type="expression">MIT</license><requireLicenseAcceptance>false</requireLicenseAcceptance></metadata><files><file src="tools\\**" target="tools" /></files></package>\n`;
}
